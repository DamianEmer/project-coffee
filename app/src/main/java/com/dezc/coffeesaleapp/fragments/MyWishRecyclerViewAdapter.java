 ...
 */
public class MyWishRecyclerViewAdapter extends RecyclerView.Adapter<MyWishRecyclerViewAdapter.ViewHolder> {

    private static List<Product> mValues;

    public MyWishRecyclerViewAdapter(List<Product> items) {
        mValues = items;
    }
